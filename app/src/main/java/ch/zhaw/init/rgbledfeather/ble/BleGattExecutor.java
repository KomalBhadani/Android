...
abstract class BleGattExecutor extends BluetoothGattCallback {
    // Log
    ...
    private BleGattExecutor.ServiceAction serviceReadAction(final BluetoothGattService gattService, final String characteristicUuidString, final String descriptorUuidString) {
        return new BleGattExecutor.ServiceAction() {
            ...
            public boolean execute(BluetoothGatt bluetoothGatt) {
                ...
                AppLog.e(TAG,"hererere 1");
                if (characteristic != null) {
                    AppLog.e(TAG,"hererere 2");
                    if (descriptorUuidString == null) {
                        // Read Characteristic
                        AppLog.e(TAG,"hererere3 ");
                        if ((characteristic.getProperties() & BluetoothGattCharacteristic.PROPERTY_READ) != 0) {
                            AppLog.e(TAG,"hererere 4");
                    ...
                    AppLog.e(TAG, "read: characteristic not found: " + characteristicUuidString);
                    return true;
                }
            }
        };
            ...
            public boolean execute(BluetoothGatt bluetoothGatt) {
                if (characteristicUuidString != null) {
                    ...
                    if (dataCharacteristic == null) {
                        AppLog.e(TAG, "Characteristic with UUID " + characteristicUuidString + " not found");
                        return true;
                    }
                    ...
                    AppLog.e(TAG, "Characteristic UUID is null");
                    return true;
                }
            }
        };
    ...
    static BleGattExecutor createExecutor(final BleExecutorListener listener) {
        return new BleGattExecutor() {
            ...
            public void onConnectionUpdated(BluetoothGatt gatt, int interval, int latency, int timeout,
               ...
               listener.onConnectionUpdated(gatt,interval,latency,timeout,status);
            }
        };
    }
