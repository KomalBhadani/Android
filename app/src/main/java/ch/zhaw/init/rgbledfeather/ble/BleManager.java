    ...
    public boolean connect(Context context, String address) {
        ...
        if (reuseExistingConnection) {
            ...
            if (mDeviceAddress != null && address.equalsIgnoreCase(mDeviceAddress) && mGatt != null) {
                AppLog.e(TAG, "Trying to use an existing BluetoothGatt for connection.");
                if (mGatt.connect()) {
        ...
        if (mDevice == null) {
            AppLog.e(TAG, "Device not found.  Unable to connect.");
            return false;
        }
...
*/
        ...
        AppLog.e(TAG, "Trying to create a new connection.");
    ...
    public boolean refreshDeviceCache() {
        try {
            ...
            if (localMethod != null) {
                ...
                if (result) {
                    AppLog.e(TAG, "Bluetooth refresh cache");
                }
                return result;
            }
...
*/
    ...
    public void writeService(BluetoothGattService service, String uuid, byte[] value) {
        if (service != null) {
            if (mAdapter == null || mGatt == null) {
                Log.e(TAG, "writeService: BluetoothAdapter not initialized");
                return;
            }
    ...
    public void enableNotification(BluetoothGattService service, String uuid, boolean enabled) {
        if (service != null) {
            ...
            if (mAdapter == null || mGatt == null) {
                AppLog.e(TAG, "enableNotification: BluetoothAdapter not initialized");
                return;
            }
    ...
    public BluetoothGattService getGattService(String uuid) {
        AppLog.e(TAG,"getGattService: uuid service herererere");
        if (mGatt != null) {
    ...
    public void  onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
        ...
        AppLog.e(TAG,"onConnectionStateChange");
    ...
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        ...
        if (status != BluetoothGatt.GATT_SUCCESS) {
            AppLog.e(TAG, "onServicesDiscovered status: " + status);
        }
    }
    ...
    public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
        ...
        if (status != BluetoothGatt.GATT_SUCCESS) {
            AppLog.e(TAG, "onCharacteristicRead status: " + status);
        }
    }
    ...
    public interface BleManagerListener {
        ...
        void onReadRemoteRssi(int rssi);
         ...
         void onConnectionUpdated(BluetoothGatt gatt, int interval, int latency, int timeout,
                                        int status) ;
