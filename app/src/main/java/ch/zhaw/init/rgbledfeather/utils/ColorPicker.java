package ch.zhaw.init.rgbledfeather.utils;
...
import ch.zhaw.init.rgbledfeather.main.MainFragment;
...
public class ColorPicker extends View {
    ...
    public void setmListener(ColorListener mListener) {
    ...
    public ColorPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        mListener = (ColorListener) unwrap(context);
        init();
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
               ...
               /* if (colorChanged && MainFragment.isOnline() && System.currentTimeMillis() - timeRef > REQUEST_FREQ) {
